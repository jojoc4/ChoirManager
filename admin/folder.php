...
if (isset($_GET['a'])) {
    switch ($_GET['a']) {
        ...
        case 'am':
            ...
            break;
        case 'eh':
            $q = "UPDATE `folder` SET `header` = '" . addslashes($_POST['content']) . "',  `header_title` = '" . addslashes($_POST['title']) . "'";
            $q .= "WHERE `id_fld` = '" . $_GET['id'] . "';";
            $pdo->exec($q);
            break;
    }
...
<div class="container-fluid overflow-visible">
    ...
    ?>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="post" class="form-inline" action="/admin/?p=f&a=eh&id=<?php echo $_GET['id'] ?>">
                    <input type="text" value="<?php echo $folder['header_title']; ?>" name="title" placeholder="title"><br><br>
                    <textarea id="headerEditor" name="content"><?php echo $folder['header']; ?></textarea><br>
